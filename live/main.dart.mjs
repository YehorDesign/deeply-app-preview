...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: x0 => x0.disabled,
      AL: (x0,x1) => x0.removeAttribute(x1),
      AM: x0 => x0.read(),
