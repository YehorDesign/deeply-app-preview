...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AK: (x0,x1) => { x0.allowFullscreen = x1 },
      AL: x0 => x0.videoWidth,
      AM: x0 => x0.getReader(),
      ...
      BK: (x0,x1) => { x0.allow = x1 },
      BL: x0 => x0.videoHeight,
      BM: x0 => x0.value,
      ...
      HL: (x0,x1) => x0.removeAttribute(x1),
      HM: x0 => x0.loader,
      ...
      XL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      Y: (o0, o1) => [o0, o1],
      ...
      eJ: x0 => x0.frameCount,
      eK: (x0,x1) => x0.getModifierState(x1),
      ...
      iI: x0 => x0.abort(),
      iJ: x0 => x0.tracks,
      iK: x0 => x0.isComposing,
      iL: (x0,x1) => x0.setSinkId(x1),
      j: x0 => x0.random(),
      ...
      nK: x0 => x0.currentTime,
      nL: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      ...
      rJ: x0 => x0.response,
      rK: x0 => x0.buffered,
      rL: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      sK: x0 => x0.pause(),
      sL: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      t: (o, p, v) => o[p] = v,
      ...
      tK: x0 => x0.play(),
      tL: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      u: () => [],
      ...
      uK: x0 => x0.message,
      uL: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      v: (a, i) => a.push(i),
      ...
      vK: x0 => x0.load(),
      vL: (x0,x1,x2) => x0.exportKey(x1,x2),
      ...
      wK: (x0,x1) => { x0.src = x1 },
      wL: (x0,x1) => x0.getRandomValues(x1),
      ...
      xK: x0 => x0.message,
      xL: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
