...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CJ: (x0,x1) => { x0.height = x1 },
      CK: (x0,x1) => { x0.max = x1 },
      CL: (x0,x1) => x0.removeAttribute(x1),
      CM: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      DJ: (x0,x1) => { x0.width = x1 },
      DK: (x0,x1) => { x0.disabled = x1 },
      DL: x0 => x0.currentTime,
      DM: x0 => x0.assetBase,
      E: (exn) => {
      ...
      EJ: x0 => x0.style,
      EK: (x0,x1) => { x0.scrollLeft = x1 },
      EL: (x0,x1) => { x0.playbackRate = x1 },
      EM: x0 => x0.loader,
      F: () => new Error().stack,
      ...
      FJ: (x0,x1) => { x0.src = x1 },
      FK: (x0,x1) => { x0.spellcheck = x1 },
      FL: x0 => x0.pause(),
      FM: () => globalThis._flutter,
      ...
      HI: (x0,x1) => x0.get(x1),
      HJ: x0 => x0.src,
      HK: (x0,x1) => x0.transferFromImageBitmap(x1),
      HL: x0 => x0.message,
      ...
      IJ: (x0,x1) => x0.revokeObjectURL(x1),
      IK: (x0,x1) => x0.getContext(x1),
      IL: (x0,x1) => { x0.currentTime = x1 },
      ...
      KH: x0 => x0.value,
      KI: x0 => x0.name,
      KJ: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      ...
      MI: x0 => x0.url,
      MJ: x0 => x0.naturalWidth,
      MK: x0 => x0.width,
      ML: () => globalThis.window,
      N: (c) =>
      ...
      NI: x0 => x0.status,
      NJ: x0 => x0.decode(),
      NK: x0 => x0.rasterEndMilliseconds,
      ...
      OH: x0 => x0.value,
      OI: x0 => x0.getReader(),
      OJ: (x0,x1) => { x0.decoding = x1 },
      OK: x0 => x0.rasterStartMilliseconds,
      ...
      PI: x0 => x0.read(),
      PJ: (x0,x1) => { x0.crossOrigin = x1 },
      PK: x0 => x0.imageBitmaps,
      ...
      QI: x0 => x0.value,
      QJ: (x0,x1) => x0.createObjectURL(x1),
      QK: x0 => x0.canvasKitMaximumSurfaces,
      QL: (x0,x1) => x0.key(x1),
      ...
      SI: x0 => x0.cancel(),
      SJ: x0 => new Blob(x0),
      SK: (x0,x1) => x0.debug(x1),
      SL: (x0,x1,x2) => x0.setItem(x1,x2),
      T: x0 => new Promise(x0),
      ...
      UK: x0 => x0.location,
      UL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      V: (constructor, args) => {
      ...
      VK: (x0,x1) => x0.getModifierState(x1),
      ...
      eI: (x0,x1,x2) => x0.open(x1,x2),
      eJ: x0 => x0.frameCount,
      eK: (x0,x1) => { x0.volume = x1 },
      eL: x0 => x0.src,
      ...
      fK: (x0,x1) => { x0.muted = x1 },
      fL: (x0,x1) => x0.setSinkId(x1),
      ...
      jG: x0 => x0.history,
      jH: x0 => x0.click(),
      jI: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      jJ: () => globalThis.window.ImageDecoder,
      jK: x0 => x0.code,
      jL: x0 => x0.sessionStorage,
      k: o => o,
      kB: o => {
        if (o === null || o === undefined) return 0;
      ...
      kJ: x0 => x0.decode(),
      kK: x0 => x0.error,
      kL: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      lI: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      lJ: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      lK: (x0,x1) => x0.start(x1),
      lL: x0 => x0.subtle,
      m: () => globalThis.Math,
      ...
      pJ: x0 => x0.send(),
      pK: x0 => x0.videoWidth,
      pL: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      ...
      qI: x0 => x0.getAllResponseHeaders(),
      qJ: x0 => x0.status,
      qK: x0 => x0.videoHeight,
      qL: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      r: (x0,x1) => x0.focus(x1),
      ...
      rJ: x0 => x0.response,
      rK: x0 => x0.duration,
      rL: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
      ...
      sK: (x0,x1) => { x0.playsInline = x1 },
      sL: (x0,x1,x2) => x0.exportKey(x1,x2),
      t: (o, p, v) => o[p] = v,
      ...
      tI: x0 => x0.withCredentials,
      tJ: (x0,x1) => { x0.responseType = x1 },
      tK: (x0,x1) => { x0.controls = x1 },
      tL: (x0,x1) => x0.getRandomValues(x1),
      u: () => [],
      ...
      uI: (x0,x1) => { x0.timeout = x1 },
      uJ: () => new XMLHttpRequest(),
      uK: (x0,x1) => { x0.autoplay = x1 },
      uL: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      v: (a, i) => a.push(i),
      ...
      vI: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      vJ: (x0,x1,x2) => x0.insertBefore(x1,x2),
      ...
      wI: (x0,x1) => { x0.withCredentials = x1 },
      wJ: x0 => x0.id,
      ...
      xG: x0 => x0.maxHeight,
      xH: x0 => x0.content,
      xI: (x0,x1) => { x0.responseType = x1 },
      xJ: x0 => x0.offsetHeight,
      xK: (x0,x1) => { x0.border = x1 },
      xL: x0 => x0.getReader(),
      ...
      yG: x0 => x0.maxWidth,
      yH: x0 => x0.document,
      yI: x0 => x0.naturalHeight,
      yJ: x0 => x0.offsetWidth,
      yK: x0 => x0.style,
      yL: x0 => x0.value,
      ...
      zI: x0 => x0.naturalWidth,
      zJ: x0 => x0.stopPropagation(),
      zK: (x0,x1) => { x0.id = x1 },
      zL: x0 => x0.done,
