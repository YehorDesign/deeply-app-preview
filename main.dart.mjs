...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BK: x0 => x0.rasterEndMilliseconds,
      BL: (x0,x1) => x0.key(x1),
      ...
      CK: x0 => x0.rasterStartMilliseconds,
      CL: x0 => x0.length,
      ...
      DJ: x0 => x0.duration,
      DK: x0 => x0.imageBitmaps,
      DL: (x0,x1,x2) => x0.setItem(x1,x2),
      E: (exn) => {
      ...
      FK: x0 => x0.nextSibling,
      FL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      JJ: x0 => x0.frameCount,
      JK: (x0,x1) => x0.getModifierState(x1),
      ...
      SH: x0 => x0.keyCode,
      SI: x0 => x0.cancel(),
      SJ: (x0,x1,x2) => x0.addEventListener(x1,x2),
      SK: x0 => x0.currentTime,
      SL: (x0,x1) => x0.append(x1),
      T: x0 => new Promise(x0),
      ...
      UJ: x0 => x0.send(),
      UK: (x0,x1) => x0.end(x1),
      UL: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      V: (constructor, args) => {
      ...
      XJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      XK: x0 => x0.pause(),
      XL: x0 => x0.isSecureContext,
      Y: (o0, o1) => [o0, o1],
      ...
      YK: x0 => x0.play(),
      YL: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZK: x0 => x0.message,
      ZL: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      ...
      aK: x0 => x0.load(),
      aL: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      bJ: (x0,x1) => { x0.height = x1 },
      bK: (x0,x1) => { x0.src = x1 },
      bL: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      c: o => o,
      cB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cJ: (x0,x1) => { x0.width = x1 },
      cK: x0 => x0.message,
      cL: (x0,x1,x2) => x0.exportKey(x1,x2),
      d: (o, p) => o[p],
      ...
      dJ: (x0,x1) => { x0.border = x1 },
      dK: x0 => x0.code,
      dL: x0 => x0.sessionStorage,
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
      ...
      eJ: x0 => x0.style,
      eK: x0 => x0.error,
      eL: (x0,x1) => x0.getRandomValues(x1),
      ...
      fJ: (x0,x1) => { x0.allowFullscreen = x1 },
      fK: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      fL: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      ...
      jH: x0 => x0.click(),
      jI: x0 => x0.style,
      jJ: (x0,x1,x2) => x0.insertBefore(x1,x2),
      jK: x0 => x0.videoHeight,
      jL: x0 => x0.value,
      k: o => o,
      kB: o => {
        if (o === null || o === undefined) return 0;
      ...
      lI: () => globalThis.document,
      lJ: x0 => x0.offsetHeight,
      lK: (x0,x1) => { x0.playsInline = x1 },
      lL: x0 => x0.read(),
      m: () => globalThis.Math,
      ...
      mI: x0 => x0.src,
      mJ: x0 => x0.offsetWidth,
      mK: (x0,x1) => { x0.controls = x1 },
      mL: x0 => x0.body,
      ...
      nJ: x0 => x0.stopPropagation(),
      nK: (x0,x1) => { x0.autoplay = x1 },
      ...
      pJ: (x0,x1) => { x0.min = x1 },
      pK: (x0,x1) => x0.removeAttribute(x1),
      pL: x0 => x0.loader,
      ...
      rJ: (x0,x1) => { x0.disabled = x1 },
      rK: (x0,x1) => { x0.playbackRate = x1 },
      s: () => ({}),
      sB: o => {
        if (o === null || o === undefined) return 0;
