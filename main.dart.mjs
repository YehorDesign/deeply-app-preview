...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      SK: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      SL: x0 => x0.subtle,
      T: x0 => new Promise(x0),
      ...
      TK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      TL: x0 => x0.crypto,
      ...
      iK: (x0,x1) => x0.removeAttribute(x1),
      iL: x0 => x0.read(),
      j: x0 => x0.random(),
