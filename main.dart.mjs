...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CK: x0 => x0.altKey,
      CL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      RK: (x0,x1) => x0.end(x1),
      RL: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      ...
      UI: x0 => x0.headers,
      UJ: x0 => x0.send(),
      UK: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      UL: x0 => x0.isSecureContext,
      V: (constructor, args) => {
      ...
      VI: x0 => x0.signal,
      VJ: x0 => x0.status,
      VK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      VL: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      W: x0 => new Array(x0),
      ...
      WL: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      X: o => [o],
      XB: (t, s) => t.set(s),
      ...
      XK: x0 => x0.videoWidth,
      XL: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      Y: (o0, o1) => [o0, o1],
      ...
      YK: x0 => x0.videoHeight,
      YL: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZK: x0 => x0.duration,
      ZL: (x0,x1,x2) => x0.exportKey(x1,x2),
      ...
      aK: (x0,x1) => { x0.playsInline = x1 },
      aL: x0 => x0.sessionStorage,
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      bJ: x0 => x0.id,
      bK: (x0,x1) => { x0.controls = x1 },
      bL: (x0,x1) => x0.getRandomValues(x1),
      c: o => o,
      cB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cK: (x0,x1) => { x0.autoplay = x1 },
      cL: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      d: (o, p) => o[p],
      ...
      kK: (x0,x1) => x0.removeAttribute(x1),
      kL: (x0,x1) => new OffscreenCanvas(x0,x1),
      l: o => {
        if (o === undefined || o === null) return 0;
